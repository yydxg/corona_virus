    ...
    if (pickId === '') {
      ...
      fetch(requestUrl, {
        ...
        if (count === "0") {
          ...
          let routeUrl = `http://restapi.amap.com/v3/direction/driving?key=93491b0fb44d1770a55eb86d219a8ffb&origin=${sourceLng},${sourceLat}&destination=${destinationLng},${destinationLat}&originid=&destinationid=&extensions=base&strategy=0&waypoints=116.357483,39.907234&avoidpolygons=&avoidroad=`
          fetch(routeUrl, {
            method: 'GET',
            /*headers: {
                'Content-Type': 'application/json;charset=UTF-8'
