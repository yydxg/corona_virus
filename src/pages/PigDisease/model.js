import { fetchAll,deleteById,update,save,fetchByDateAndBinming} from './service';

export default {
  namespace: 'PigDisease',
  ...
  effects: {
    ...
    *findByDateAndBinming({ payload,callback  }, { call, put, select ,take}) {
      let {success,data} = yield call(fetchByDateAndBinming,payload);
      if(success){
        yield put({
          type:'init_images',
          payload:data
