/* global mars3d Cesium MeasureTool*/
...
import {draw,addPie } from './pie/fun'
  ...
  render(){
    ...
    return(
        <div className={styles.manage}>
          <div style={{position:'absolute',width: '250px',height: '30px', top: '20px', right: '10px',zIndex:1000}}>
            <div id="measure"> </div>
          </div>
          <div className={styles.cesiumContainer} id="cesiumContainer">
            <div className={styles.buttons}>
              <Tooltip placement="right" title="测量" onClick={()=>this.measure()}>
          ...
          {viewer && <Pie parent={this} viewer={viewer} visible = {chartVisible}/>}

          {viewer && <Source parent={this} viewer={viewer} visible = {sourceVisible}/>}
        </div>
    )
  }
}
