        ...
        this.props.dispatch({
          ...
          if(success && data){
            ...
            if(!data){
              ...
              // this.props.history.push('/fish/config/users')
              // this.props.history.push('/PigDisease')
              // this.props.history.push('/PigDisease')
            }
          }else{
            Modal.info({
  ...
  render() {
    ...
    return (
      <div style={{width:'500px',margin: '0 auto',padding:'200px 0 0 0',height:'50px'}}>
        {/* <h1 style={{textAlign:"center"}}>智慧出行可视化决策支持平台</h1> */}
        <h1 style={{textAlign:"center"}}>xxxx</h1>
