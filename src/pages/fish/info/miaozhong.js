      ...
      <div className={styles.Fish} style={{ paddingTop: 100 }}>
        ...
        <Row style={{ marginBottom: 10 }}>
          ...
          <Col offset={8} span={12}>
            <Form layout={"inline"}>
              <Form.Item label="鱼种名称" style={{ height: 20 }}>
                <Input
                  placeholder="饲料名称"
      ...
      return (
        ...
        >
          <Form layout="horizontal">
            ...
            <Form.Item label="苗种编号" {...formItemLayout}>
              {getFieldDecorator('v1', {
                rules: [{ required: true, message: 'please enter 苗种编号 !' }],
              })(<Input disabled={title==='修改'?true:false} />)}
            </Form.Item>
            <Form.Item label="苗种名称" {...formItemLayout}>
              {getFieldDecorator('v2', {
                rules: [{ required: true, message: 'please enter 苗种名称 !' }],
              })(<Input />)}
            </Form.Item>
            ...
            <Form.Item label="库存量（尾）" {...formItemLayout}>
