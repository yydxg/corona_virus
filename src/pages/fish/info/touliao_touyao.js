...
import Touliao2 from './touliao2'

var lastStage;
@connect(({ Fish, F_Login }) => ({
  Fish, F_Login
}))
class Touyao_Touliao extends Component {
  constructor(props) {
    super(props)
    this.state = {
      visible: false,
  ...
  showVisual = (flag) => {
    ...
    var scanColor = flag ? new Cesium.Color(1.0, 0.0, 0.0, 1):new Cesium.Color(0.0, 0.0, 1.0, 1);
  ...
  render() {
    ...
    return (
      <>
        <div className={styles.Fish} style={{ paddingTop: 100, position: 'absolute', width: '60%' }}>
          ...
          <Touliao2 showVisual={()=>this.showVisual(0)}/>
        ...
        <div id="cesiumDiv" style={{ width: '40%', height: '150%', right: 0, position: 'absolute' }}></div>
      </>
    )
  }
}
...
export default connect()(Form.create()(Touyao_Touliao))
/**
