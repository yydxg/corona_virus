...
class Buhuo extends Component {
        ...
        this.isV1Unique(values.v1).then(r => {
          ...
          if (success && data) {
            dispatch({
              type: 'Fish/save',
              payload: {
                data: { ...values,v3: values.v3.split(',')[0], module: 'buhuo', v7: moment().format('YYYY-MM-DD'), v9: tempdata.v2 }
              }
            }).then(r => {
              console.log(r);
              r.success && this.initTable()
  ...
  showUpdateModal = (vid) => {
    ...
    const { id, v1, v2, v3, v4, v5, v6, v7, v9 } = da
    form.setFieldsValue({
      id, v1, v2, v3, v4, v5, v6, v7, v9
    })
      ...
      <div className={styles.Fish} style={{ paddingTop: 100 }}>
        ...
        <Card>
          <Table
            ...
            columns={[
              {//捕获时间v7、鱼塘名称v2,鱼塘编号v1、鱼苗品种v3、数量v4、重量v5、放养总天数v6、捕获人员v9
                title: '捕获批次',
                dataIndex: 'v1',
                key: 'v1',
              },
      ...
      return (
        ...
        >
          <Form layout="horizontal">
            ...
            <Form.Item label="鱼苗品种" {...formItemLayout}>
            ...
            <Form.Item label="数量（条）" {...formItemLayout}>
              {getFieldDecorator('v4', {
                rules: [{ required: true, message: 'please enter 数量（条） !' }],
              })(<InputNumber min={1} step={1} />)}
            </Form.Item>
            <Form.Item label="重量" {...formItemLayout}>
              {getFieldDecorator('v5', {
                rules: [{ required: true, message: 'please enter 重量 !' }],
              })(<InputNumber min={0} />)}
            </Form.Item>
            <Form.Item label="放养天数" {...formItemLayout}>
              {getFieldDecorator('v6', {
                rules: [{ required: true, message: 'please enter 放养天数 !' }],
              })(<InputNumber min={1} step={1} />)}
            </Form.Item>
            <Form.Item label="捕获时间" {...formItemLayout} style={{ display: 'none' }}>
            ...
            <Form.Item label="捕获人员" {...formItemLayout} style={{ display: 'none' }}>
